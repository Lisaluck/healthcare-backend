...
class PatientDoctorMapping(models.Model):
    ...
    def clean(self):
        if self.patient and self.doctor and PatientDoctorMapping.objects.filter(patient=self.patient, doctor=self.doctor).exists():
            raise ValidationError("This doctor is already assigned to the patient.")